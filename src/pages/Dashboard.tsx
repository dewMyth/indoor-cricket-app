...
const options = [
  {
    ...
    desc: "Set up teams and begin scoring",
    icon: "🏏",
    path: "/match/create",
    accent: "pitch",
  },
  ...
  {
    label: "Match History",
    desc: "Browse completed & saved matches",
    icon: "📜",
    path: "/history",
    accent: "sixer",
  },
  {
    label: "Profile",
    desc: "Your account and preferences",
    icon: "👤",
    path: "/profile",
    accent: "stump",
  },
